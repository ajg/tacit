...
static_assert(std::is_same_v<tacit::bind<std::map, _::blank<>, _::blank<>>::with<char, int>,
                             std::map<char, int>>);
static_assert(
    std::is_same_v<tacit::bind<std::map, int, _::blank<>>::with<double>, std::map<int, double>>);
static_assert(
    std::is_same_v<tacit::bind<std::map, _::blank<>, int>::with<char>, std::map<char, int>>);
