...
// Policy checks (preprocessor): generators gone on the clean path, feature flag kept. The macro
// list lives in no_generator_macros.hpp so this claim and order_body.hpp's cannot drift apart.
