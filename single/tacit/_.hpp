...
// the spelling stays `#include <tacit/_.hpp>`, exactly as from the repo.
// _.hpp and $.hpp may be included together, in either order — the shared core is
// deduplicated by TACIT_SINGLE_CORE_SEEN.
#pragma once
